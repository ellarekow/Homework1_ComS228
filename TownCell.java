		...
		for(int i = 0; i < plain.getLength(); i++) {
			for(int j = 0; j < plain.getWidth(); j++)
				...
				case STREAMER:
					...
					break;
				default:
					System.out.println("ERROR: NO SUCH MEMBER FOR CENSUS");
					break;
				}
		}
//		System.out.println("R:" + nCensus[RESELLER] + " E:" + nCensus[EMPTY] + " C:" + nCensus[CASUAL] + " O:"+ nCensus[OUTAGE] + " S:" + nCensus[STREAMER]); 
	}
